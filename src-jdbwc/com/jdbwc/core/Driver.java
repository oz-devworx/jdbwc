 ...
 * to determine suitability for a given URL and start a connection if the Driver is suitable.<br />
 * <i>Normally the methods in WCDriver would be in this class 
 * but were migrated to reduce the standby footprint size.</i>.
 * 
 * @author Tim Gall (Oz-DevWorX)
 * @version 2008-05-29
 */
public class Driver extends WCDriver {
