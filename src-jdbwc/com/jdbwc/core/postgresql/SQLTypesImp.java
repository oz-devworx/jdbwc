...
public final class SQLTypesImp implements com.jdbwc.util.SQLTypes {
    ...
    private static final int INT2_ARRAY = 1005;
    private static final int INT4 = 23;
    private static final int INT4_ARRAY = 1007;
    private static final int INT8 = 20;
    private static final int INT8_ARRAY = 1016;
    private static final int TEXT = 25;
    private static final int TEXT_ARRAY = 1009;
    private static final int NUMERIC = 1700;
    private static final int NUMERIC_ARRAY = 1231;
    private static final int FLOAT4 = 700;
    private static final int FLOAT4_ARRAY = 1021;
    private static final int FLOAT8 = 701;
    private static final int FLOAT8_ARRAY = 1022;
    private static final int BOOL = 16;
    private static final int BOOL_ARRAY = 1000;
    private static final int DATE = 1082;
    private static final int DATE_ARRAY = 1182;
    private static final int TIME = 1083;
    private static final int TIME_ARRAY = 1183;
    private static final int TIMETZ = 1266;
    private static final int TIMETZ_ARRAY = 1270;
    private static final int TIMESTAMP = 1114;
    private static final int TIMESTAMP_ARRAY = 1115;
    private static final int TIMESTAMPTZ = 1184;
    private static final int TIMESTAMPTZ_ARRAY = 1185;
    private static final int BYTEA = 17;
    private static final int BYTEA_ARRAY = 1001;
    private static final int VARCHAR = 1043;
    private static final int VARCHAR_ARRAY = 1015;
    private static final int OID = 26;
    private static final int OID_ARRAY = 1028;
    private static final int BPCHAR = 1042;
    private static final int BPCHAR_ARRAY = 1014;
    private static final int MONEY = 790;
    private static final int MONEY_ARRAY = 791;
    private static final int NAME = 19;
    private static final int NAME_ARRAY = 1003;
    private static final int BIT = 1560;
    private static final int BIT_ARRAY = 1561;
    private static final int VOID = 2278;
    private static final int INTERVAL = 1186;
    private static final int INTERVAL_ARRAY = 1187;
    private static final int CHAR = 18; // This is not char(N), this is "char" a single byte type.
    private static final int CHAR_ARRAY = 1002;
    private static final int VARBIT = 1562;
    private static final int VARBIT_ARRAY = 1563;
	...
	public String nativeNameToJdbcName(String pgsqlType) {
	 ...
	 */
	public int nativeNameToJdbcType(final String pgsqlType) {
		if (pgsqlType.toLowerCase().endsWith("_array")) {
	 ...
	 */
	public int nativeNameToNativeType(String pgsqlType) {
	 ...
	 */
	public String nativeTypeToJdbcName(final int pgsqlType) {
		switch (pgsqlType) {
	 ...
	 */
	public int nativeTypeToJdbcType(final int pgsqlType) {
	 ...
	 */
	public String nativeTypeToNativeName(final int pgsqlType) {
		switch (pgsqlType) {
	...
	public SQLField updateField(final SQLField field) {
		...
		field.isSearchable = true;//TODO: add real postgres value
		field.isCurrency = (field.genericSqlType==MONEY || field.genericSqlType==MONEY_ARRAY);
