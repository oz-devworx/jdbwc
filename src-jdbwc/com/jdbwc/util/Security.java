...
public final class Security {
	...
	private static final int SALT_LENGTH = 16;//dont change this
	...
	public static String getHash(final String algorithm, final String input) throws SQLException {
		...
		try {
			...
			//preserve leading zeros. The conversion to string removes them.
			...
			throw new SQLException(
					"NoSuchAlgorithmException: Error accessing a Java algorithm for: " + algorithm,
					"WCNAE",
					e);
		}
		return output;
	...
	public static String rand(final int aListSize, boolean alphNumericOnly, boolean numericOnly) {
		...
		/* improves the randomness of the output */
