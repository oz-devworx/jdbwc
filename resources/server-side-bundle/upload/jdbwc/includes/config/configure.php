...
define('WC_WSITE_DIR', '/testing/'); // absolute web file path with trailing /
define('WC_LOG_PATH', '/home/public_html/testing/jdbwc/includes/wc_logs/');// absolute path with trailing /
define('WC_FILE_SESSIONS', '/home/public_html/testing/jdbwc/includes/sessions'); // absolute path without trailing /

define('WC_STORE_SESSIONS', 'sqlite'); //'files' or 'sqlite' (make sure the one you use is a registered save handler in phpinfo())
