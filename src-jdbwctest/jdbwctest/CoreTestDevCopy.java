...
/**
 * This class is designed for JDBWC-1.0.0.4-beta.<br />
 ...
 * <br /><br />
 * <b>SUMMARY:</b><br />
 * 1) Create a database (server-side) and give it a user. Be sure to enter the database name in the class variable <code>database</code>.<br />
...
public class CoreTestDevCopy {
	...
	/** Output stream. System.out is the default */
	PrintStream syserr = System.err;
	/** Error stream. System.err is the default */
...
//				e1.printStackTrace();
	 ...
	 * OPTIONAL PARAMETERS:
	 * <pre>
	 * proxyUrl          proxy url (domain or IP) EG: http://myproxy.myserver.ext:8181
	 *
...
//		      //remote 1 (dedicated IP's OK with http & https)
//		      database = "ozdev_jdbwctest";
//		      final String wcDataBase = database;
//		      final String wcUser = "ozdev_admin";
//		      final String wcPass = "gwIXz95Tdb75mNjaQ2";
//
//		      final String httUrlStr = "https://oz-devworx.com.au/foobar/";
//		      final String user = "ozdevworx";
//		      final String pass = "kB1pT3YvVpaR";


//		      //remote 2 (dedicated cpanel subdomains NOT OK)
//		      database = "phpdev_jdbwctest";
//		      final String wcDataBase = database;
//		      final String wcUser = "phpdev_ozdev";
//		      final String wcPass = "exRFvTlXy4nM";
		//
//		      final String httUrlStr = "http://phpdev.oz-devworx.com/temp/";
//		      final String user = "ozdevworx";
//		      final String pass = "kB1pT3YvVpaR";


//		      //remote 2 (dedicated cpanel subdomains NOT OK)
//		      database = "devworx_jdbwctest";
//		      final String wcDataBase = database;
//		      final String wcUser = "devworx_user";
//		      final String wcPass = "qgDu,Xa8{+#2";
		//
//		      final String httUrlStr = "http://foobar.oz-devworx.net/";
//		      final String user = "ozdevworx";
//		      final String pass = "kB1pT3YvVpaR";


//		      //remote 3 (dedicated subdomains NOT OK)
//		      database = "osfaq_jdbwctest";
//		      final String wcDataBase = database;
//		      final String wcUser = "osfaq_user";
//		      final String wcPass = "|lvJy7AA~EwN";
		//
//		      final String httUrlStr = "http://osfaq.oz-devworx.com.au/asdhjkyu/";
//		      final String user = "ozdevworx";
//		      final String pass = "kB1pT3YvVpaR";
			...
			final String databaseUser = "ozdevworx";
			final String databasePass = "BzbSeEp26KPxF5WH7vq9";

			final String hostURL = "http://terrabot:8085/";
			final String hostUser = "ozdevworx";
			final String hostPass = "wkxUZ75CvsoLjqE";
...
//		      }
		     ...
		     * connection = DriverManager.getConnection(url, hostUser, hostPass);
		     * ****************************************/
...
//		    props.put("proxyUrl", "http://firewall.terracotta:800");//unregistered name stored in local DNS
...
//	    	syserr = new PrintStream(fileStream);
	...
	private void testDatabaseMetaDataFromInfoSchema() throws SQLException, Exception{
		 ...
		 * Mysql native driver and postgresql native driver can't handle this. JDBWC is OK with it.
		 * I suspect the native Mysql driver limitation is due to something in the syntax but haven't verified this suspicion yet.
		 */
...
//		results = dbmd.getColumnPrivileges(database, null, "test01", "%");
...
//		results.close();
		...
		/* XXX: Commented out due to speed limitations in the current JDBWC MySQL implementation.
		 * PostgreSQL speeds seem OK, however the queries may still require some fine tuning.
		 * NOTE: MySQL getExportedKeys is significantly slower (4x approx.) than getImportedKeys
		 * in this implementation.
		 */
//		long startTime = System.currentTimeMillis();
//		results = dbmd.getImportedKeys(database, null, "test02");
//		System.out.println("CALLED: getImportedKeys(\""+database+"\", null, \"test02\")");
//		columnIndex = 1;
//		while(results.next()){
...
//		results = dbmd.getExportedKeys(database, null, "test02");
//		System.out.println("CALLED: getExportedKeys(\""+database+"\", null, \"test02\")");
//		columnIndex = 1;
//		while(results.next()){
...
//		connection.setCatalog(database);
		 ...
		 * Step up the testing a bit by using ResultSetMetaData for reading DatabaseMetaData resultsets.
		 */
		results = dbmd.getColumns("termishop", null, "orders", "%");
		resultsMd = results.getMetaData();
		System.out.println("CALLED: getColumns(\"termishop\", null, \"orders\", \"%\")");
		columnIndex = 1;
		while(results.next()){
