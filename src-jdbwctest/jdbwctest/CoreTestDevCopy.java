...
/**
 * This class is designed for JDBWC-1.0.0.3-beta.<br />
...
//		      //remote 2 (dedicated cpanel subdomains NOT OK)
//		      databaseName = "devworx_jdbwctest";
//		      final String wcDataBase = databaseName;
...
//		      final String pass = "kB1pT3YvVpaR";
		      ...
		      //local (OK)
		      databaseName = "jdbwctest";
		      final String wcDataBase = databaseName;
		      final String wcUser = "ozdevworx";
		      final String wcPass = "BzbSeEp26KPxF5WH7vq9";

		      final int port = 80;
		      final String httUrlStr = "http://localhost/";
		      final String user = "ozdevworx";
		      final String pass = "wkxUZ75CvsoLjqE";
